                  ...
                  <div class="row">
                     ...
                     <div class="col-6">
                        <div class="float-right">
                           ...
                           <a href="{{route('tarefa.exportacao', ['extensao' => 'xlsx'])}}" class="mr-2">XLSX</a>
                           <a href="{{route('tarefa.exportacao', ['extensao' => 'csv'])}}" class="mr-2">CSV</a>
                           <a href="{{route('tarefa.exportacao', ['extensao' => 'pdf'])}}" class="mr-2">PDF</a>
